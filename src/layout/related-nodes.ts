...
export function getChildNodes(node: GroupItem, edges: readonly DiagramEdge[]): DiagramNode[] {
...
export function getParentNodes(node: GroupItem, edges: readonly DiagramEdge[]): DiagramNode[] {
