...
// box.ts. `getTextBox` is `null` too for now - `input.py` does override
// `self.textbox` (narrowed by the parallelogram's slant, above), but
// that's only wired up once connectors.ts/icon.ts exist (Step 17c/18a).
