...
import type { GroupItem } from "./related-nodes.js";
...
function findRealEdgesIntoChild(parent: AnyGroup, child: GroupItem, allEdges: readonly DiagramEdge[]): DiagramEdge[] {
...
export function getParentNodeYPos(parent: AnyGroup, child: GroupItem, allEdges: readonly DiagramEdge[]): number | null {
